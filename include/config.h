...
#define BOARDNAME       "µL¼Æ¤£¾Ç"		/* ¤¤¤å¯¸¦W */
#define BBSNAME         "CCUMATH-BBS"		/* ­^¤å¯¸¦W */
#define MYHOSTNAME      "bbs.math.ccu.edu.tw"			/* ºô§} */
#define MYIP		"140.123.63.253"			/* IP */
#define MYVERSION       "WD-BBS 2.9 SNAP"		/* µ{¦¡ª©¥» */
#define MYBBSID         "CCUMATH"				/* Âà«H¥N½X */
...
#define LOGINATTEMPTS	(4)	/* ³Ì¤j¶i¯¸¥¢»~¦¸¼Æ */
...
#define MAX_REVIEW      (14)            /* ³Ì¦h¤ô²y¦^ÅU */
...
#define MAX_NOTE        (18)            /* ³Ì¦h«O¯d´X½g¯d¨¥¡H */
#define MAXSIGLINES     (8)             /* Ã±¦WÀÉ¤Þ¤J³Ì¤j¦æ¼Æ */
#define MAXQUERYLINES   (15)            /* Åã¥Ü Query/Plan °T®§³Ì¤j¦æ¼Æ */
...
#ifdef  DOTIMEOUT
#define IDLE_TIMEOUT    (20*60)	/* ¤@¯ë±¡ªp¤§ timeout (¬í)*/
...
#define DEF_MAXP	3000	/* ¬ÝªO¤å³¹°ò¥»¤W­­¼Æ¶q */
#define DEF_MAXT	60	/* ¬ÝªO¤å³¹°ò¥»«O¯d¤Ñ¼Æ */
