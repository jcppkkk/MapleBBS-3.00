...
#define LOTTO_AMOUNT_MAX 200000   //每個人可以下注的最高數
...
#define LOTTO_OPEN_END "2130" 
#define LOTTO_ANTE_MIN 1	//最小押金

/* 以下為賠率, 站長自行修改 */
#define LOTTO_RATE_1 1000000		//1獎賠率(6碼)
#define LOTTO_RATE_2 100000		//2獎賠率(5碼+特別號)
#define LOTTO_RATE_3 5000		//3獎賠率(5碼)
#define LOTTO_RATE_4 100		//4獎賠率(4碼)
#define LOTTO_RATE_5 15			//5獎賠率(3碼)
