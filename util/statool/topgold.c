...
top()
{
  ...
  fprintf(fp, "\
[1;33m¡³¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢s¡÷ [44;33m       ª÷¹ô±Æ¦æº]      [33;40m ¡ö¢s¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¡³[m\n\
[1;37m¦W¦¸[33m¢w[37m¥N¸¹[33m¢w¢w¢w[37m¼ÊºÙ[33m¢w¢r¢w¢w¢w¢w¢w[37m°]²£   ¦W¦¸[33m¢w[37m¥N¸¹[33m¢w¢r¢w[37m¼ÊºÙ[33m¢w¢w¢w¢w¢w¢w[37m°]²£[m\
");
  for (i = 0; i < rows; i++)
  {
    sprintf(buf1, "[%2d] %-11.11s%-15.15s %5d%c",
      i + 1, allman[i].userid, allman[i].username,
      allman[i].money > 100000 ? allman[i].money/1000 : allman[i].money,
      (allman[i].money > 100000) ? 'K' : ' ');
    j = i + rows;
    sprintf(buf2, "[%2d] %-11.11s%-15.15s %5d%c",
