     ...
     GMENU *pm;
{
  ...
  move (b_lines, 0);
  outs (pm->level ?
	COLOR2 " ¡iªO  ¥D¡j " COLOR1 "[1m [33;200;442;626m(Ctrl+Z)[37m»¡©ú  [33;200;442;506m(q/¡ö)[37mÂ÷¶}  \
[33;200;442;710m(n)[37m·s¼W¤å³¹  [33;200;442;703m(g)[37m·s¼W¥Ø¿ý  [33;200;442;701m(e)[37m½s¿èÀÉ®×  [0;201m" :
	COLOR2 " ¡i¥\\¯àÁä¡j " COLOR1 "[1m [33;200;442;626m(Ctrl+Z)[37m»¡©ú  [33;200;442;506m(q/¡ö)[37mÂ÷¶}  \
[33;200;442;505;612m(k¡ô[200;442;506;612mj¡õ)[37;201m²¾°Ê´å¼Ð  [33;200;442;613m(enter/¡÷)[37mÅª¨ú¸ê®Æ  [0;201m");
}
     ...
     AMENU *pm;
{
  ...
  showtitle ("ºëµØ¤å³¹", pm->mtitle);
  prints ("   [1;32m½s¸¹    ¼Ð      ÃD%54s[0m", "½s    ¿ï      ¤é    ´Á");
     ...
     AMENU *pm;
{
  ...
  if (getdata (b_lines - 1, 1, "·s¼ÐÃD¡G", buf, 60, EDIT, buf))
    {
