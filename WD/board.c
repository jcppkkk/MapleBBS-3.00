  ...
  boardheader *bptr;
{
  ...
  if (belong ("etc/cpoker", cuser.userid)) 
    return 1;
...
brdlist_foot()
{
  prints(COLOR2"  ¿ï¾Ü¬ÝªO  "COLOR1"[1m  [200;699;442m[33m(c)[37m·s¤å³¹¼Ò¦¡ \
 [33;200;442;718;612m(v)[37m¼Ð°O¤wÅª[33m\
[200;442;686;612m  (V)[37m¥¼Åª[201m \
 [33;200;442;721m(y)[37m¦C¥X%s[201m \
 [33;200;442;722;612m(z)[37m¨ú®ø/­q¾\\[201m   [m",
    yank_flag ? "­q¾\\" : "¥þ³¡");
}
/*
woju
...
#ifdef HYPER_BBS
    prints(HB_BACK"[200;442;507m[¡÷]¾\\Åª [200;442;504;612m[¡ô[200;442;505;612m¡õ][201m¿ï¾Ü [S]±Æ§Ç[/]·j´M [200;442;626m[^Z]¨D§U [200;442;621m[^U]¯¸¤W¦W³æ [200;442;500;612m[PgUp[201m/[200;442;632;612mPgDn][201m\n"
...
#ifdef HYPER_BBS
	sprintf(hbuf,"[200;400;444;300m[%dm[%dm[%dm[%dm[%dm[613;613;612m",
	  (head/10000)+648,
	  ((head%10000)/1000)+648,
	  ((head%1000)/100)+648,
	  ((head%100)/10)+648,
