...
//          "pqrsPQRStuwbTUWBcefgCEFGhjkmHJKM"[(i / 32) % 8];
	"pqrsPQRStuwbTUWBcefgCEFGhjkmHJKM"[i & 31];
        line[sizeof("/dev/ptyp") - 1] = 
//        "0123456789abcdefghijklmnopqrstuv"[i % 32];
	"0123456789abcdefghijklmnopqrstuv"[(i >> 4)& 31];
#else
        line[sizeof("/dev/ptyp") - 2] =
...
#else
  sprintf(buf, "/home/bbs/run/bbsd.pid");
#endif
