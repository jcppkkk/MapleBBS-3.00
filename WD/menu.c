...
//  char buf2[][];
  ...
  move(2,0);
#ifdef HYPER_BBS
  prints(COLOR1"\033[1m[200;442;506;612m[¡ö]¤W¤@­¶[201m ¥\\ ¯à       »¡    ©ú                    [1;33m[200;442;626m[Ctrl-Z][201m   [200;442;621m[Ctrl-U][201m         [m");
#else
...
//  adm_edit_m2,  PERM_SYSOP,     "SSet Board2    [½s¿è¤p¬ÝªO]",0,
...
"SO/xyz.so:x_innbbsd",PERM_SYSOP,"IInnbbsd       [ §ó·sÂà«H ]",1,
NULL, 0, NULL,0};
...
//   board, 0,          "CClass        [¥»¯¸¤ÀÃþ¬ÝªO]",0,
  board, 0,		"00[1;37m¯¸°ÈºÞ²z³B  [0;37m[[1;36m¤½§i,¯¸ªø,¯¸°È[0;37m][m",0,
  board, 0,		"11[1;37mÁp¦X¶Ç¼½ºô  [0;37m[[1;33m®Õ¶é,ªÀ¹Î,¯Zª©[0;37m][m",0,
  board, 0,		"22[1;37m¤å¤Æ´Ï®§¦a  [0;37m[[1;36m¾Ç³N,¤åÃÀ,­µ¼Ö[0;37m][m",0,
  board, 0,		"33[1;37m¤ô®w¬ª¬x°Ï  [0;37m[[1;33m¶¢²á,·s»D,­Ó¤H[0;37m][m",0,
  board, 0,		"44[1;37m¥ð¶¢¹B°Ê³õ  [0;37m[[1;36m¹qª±,®T¼Ö,¹B°Ê[0;37m][m",0,
  board, 0,		"55[1;37m¹q¸£ª¾ÃÑºô  [0;37m[[1;33m³nÅé,µwÅé,ºô¸ô[0;37m][m",0,
...
static struct MENU finlist[] = {
  "SO/buy.so:bank",     0,      "11Bank           \033[1;36mµL¼Æ»È¦æ\033[m",1,
  "SO/pip.so:pip_money",0,      "22ChickenMoney   Âûª÷§I´«³B     ´«¿úµ¹¹q¤lÂû¥Î",1,
  "SO/song.so:ordersong",0,     "33OrderSong      \033[1;33mµL¼ÆÂIºq¾÷\033[m     $5g/­º",1,
  "SO/buy.so:p_cloak",  0,      "44Cloak          Á{®ÉÁô¨­/²{¨­  $2g/¦¸     (²{¨­§K¶O)",1,
  "SO/buy.so:p_from",   0,      "55From           ­×§ï¬G¶m       $5g/¦¸",1,
  "SO/buy.so:p_exmail", 0,      "66Mailbox        ÁÊ¶R«H½c¤W­­   $1000g/«Ê",1,
  "SO/buy.so:p_fcloak", 0,      "77UltimaCloak    ²×·¥Áô¨­¤jªk   $10000g      ¥i¥Ã¤[Áô§Î",1,
  "SO/buy.so:p_ffrom",  0,      "88PlaceBook      ¬G¶m­×§ïÄ_¨å   $50000g     User¦W³æ«öF¥i§ï¬G¶m",1,
//  "SO/buy.so:p_ulmail", 0,      "99NoLimit        «H½cµL¤W­­     $1000000g   «H½c¤W­­µL­­¨î",1,
NULL, 0, NULL,0};
...
//    "RRPG        ¡½ ¨¤¦â§êºt¹CÀ¸           ¬I¤u¤¤",0,
  ...
  "SO/pip.so:p_pipple",PERM_LOGINOK,
    "CChicken    ¡» µL¼Æ¹q¤lÂû             §K¶Oµ¹§Aª±!!",1,
  "SO/xyz.so:x_tetris",0,
    "TTetris     ¡» «XÃ¹´µ¤è¶ô             §K¶Oµ¹§Aª±",1,
  "SO/mine.so:Mine",0,
    "LLandMine   ¡» «lÃz½ò¦a¹p             ¨C¦¸100s",1,
  ...
  "SO/lotto.so:menu_lotto",0,
    "55Lotto     ¡º µL¼Æ¼Ö³zÃ±½ä¯¸         ³Ì§C®ø¶O $1g",1,
  "SO/lo.so:q_lotto",PERM_NOTOP,
    "66Lotto     ¡º ¥]µP¼Ö³zÃ±½ä¯¸ ",1,
...
game_list()
{
  domenu(GAME, "ºô¸ô¹C¼Ö³õ", 'N', gamelist);
  return 0;
}
#endif
