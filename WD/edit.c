...
//      getdata(3, 0, "½Ð¿é¤J§A·Q¥ÎªºID¡A¤]¥iª½±µ«ö[Enter]¡A©Î¬O«ö[r]¥Î¯u¦W¡G",real_name, 12, DOECHO,0);
     getdata(3, 0, "¥Î¯u¦W½Ð«ö[y]¡A©Îª½±µ«ö[Enter]¡A°Î¦W½Ð«ö[n]¡G",buf , 2 , DOECHO , "y");
     if (*buf == 'n')
     {
      getdata(4, 0, "½Ð¿é¤J§A·Q¥ÎªºID¡A¤]¥iª½±µ«ö[Enter] ¡G",real_name, 12, DOECHO,0);
      if(!real_name[0])
       {
        strcpy(real_name,"µL¼Æµ¶»y");
...
//     fprintf(fp, "\n--\n[1;36m¡°Post by [37m%-13s [36mfrom [33m%-24.24s[m",cuser.userid, getenv("RFC931"));
        fprintf(fp, "\n--\n[1;37m    ùúùû[31mµL[32m¼Æ[33m¤£[36m¾Ç [35mIP
...
[1;37;44m  ùüùý£r   [1;32m¢ª[40m¢f[44m¢«¢ª[40m¢f[44m¢«¢ª¢i¢«[;36;44m¢¨¢«  ¢« ¢ª ¢¨¢«[34;46m¢g[36;44m¢l¢¨¢«  ¢¨¢« ¢¨¢«  [1;37m ¢ì£q    [m
...
[1;37m    ¢x     [32;47m¢e[40m    [47m¢e[40m    [47m¢e[40m  [47m¢e[;36m  ¢¨¢«¢i¢«¢m  ¢¨¢«¢l  ¢¨¢«  ¢¨[30;46m     [36;40m¢«[m
[1;37;44m  ùüùý£r   [1;32m¢ª[40m¢f[44m¢«¢ª[40m¢f[44m¢«¢ª¢i¢«[;36;44m¢¨¢«  ¢« ¢ª ¢¨¢«[34;46m¢g[36;44m¢l¢¨¢«  ¢¨¢« ¢¨¢«  [1;37m ¢ì£q       [m
[0;37m¡°[1;36mPost by [37m²q²q§Ú¬O½Ö            [36mfrom [33m bbs.math.ccu.edu.tw [m\n");
  else {
    char temp[33];
  ...
  int saveheader;
{
  ...
  switch (ans[0])
  {
    ...
    case 'T':
      ...
      if (getdata(4, 0, "·s¼ÐÃD¡G", ans, TTLEN, EDIT,save_title))
