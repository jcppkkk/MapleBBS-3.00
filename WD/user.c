  ...
  int real;
{
  ...
  prints("  [32m¨p¤H«H½c¡G[37m%-4d «Ê         [32m§Q®§µo©ñ¡G[37m%s"
	...
	{
  prints(
"  [32mª÷¹ô¼Æ¶q¡G[37m%-16ld[32m»È¹ô¼Æ¶q¡G[37m%-16ld[32m¸gÅç­È¡G[37m%-ld\n"
"  [32m»È¹ô¤W­­¡G[37m%-16ld[32m«H½c¤W­­¡G[37m%d «Ê  \n"
"  [32m¤H®ð«ü¼Æ¡G[37m%-16ld[32m¦n©_«ü¼Æ¡G[37m%-16ld[32m¤ß±¡¡G[37m%-4.4s\n"
"  [32m³Q½Ö¬d¸ß¡G[37m%-16.16s[32m¬d¸ß¢×¢Ò¡G[37m%-16.16s \n"
"  [32mµo°T®§¼Æ¡G[37m%-16d[32m¦¬°T®§¼Æ¡G[37m%-16d \n"
"  [32m¤W¯¸¦aÂI¡G[37m%s \n"
  ...
  int real, unum;
{
  ...
  case '1':
    move(0, 0);
    outs("½Ð³v¶µ­×§ï¡C");
    getdata(i++, 0," ¼Ê ºÙ  ¡G",x.username, 20, DOECHO,x.username);
...
// wildcat:¤£­nÅý user µù¥U§¹¶Ã§ï¦W¦r? 
      ...
      if (getdata(i++, 50,"¸gÅç­È¡G", buf, 10, DOECHO,genbuf))
        if ((l = atol(buf)) >= 0)
          x.exp = l;
...
showplans(char* uid)
{
  ...
  switch (getans("[1]°ò¥»¸ê®Æ [2]Ã±¦WÀÉ [3]ºëµØ¤å³¹ [4]­Ó¤H§@«~ [5]¯d¨¥µ¹(¥L/¦o) [q]Â÷¶}? "))
  {
    case '1':    
      my_query(uid);
      break;
...
showplans2(char* uid)
{
  ...
  outs("[1;36m ¡º[1;32m¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w¢w[1;36m¡º[m");  
  sethomefile(genbuf, uid, fn_plans);
  if (!show_file(genbuf, 9, MAXQUERYLINES, ONLY_COLOR)) 
//  prints("[8;1H[1;32m¡i­Ó¤H¦W¤ù¡j[m%s ¥Ø«e¨S¦³¦W¤ù", uid);
  outs("");
}
