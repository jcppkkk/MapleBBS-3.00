      ...
      if (!viewed)              /* begin of file */
      {
        if (showansi)           /* header processing */
        {
          ...
          while (pos < line)
          {
            ...
            {
              ptr[-1] = '\0';
              prints("[1;36m%s[37m%-53.53s[36m[%.4s][33m%-13s[0m\n", head[0], word, ptr, ptr + 5);
            }
            else if (pos < (local ? 3 : 4))
              prints("[1;36m%s[37m%-72.72s[0m\n", head[pos], word);
...
#ifdef HYPER_BBS
      prints(COLOR1"  [33;200;442;626m(^Z)[37m¨D§U[201m  \
[33;200;442;505;612m¡õ\
[200;442;500;612m[PgUp]\
[200;442;501;612m[PgDn]\
[200;442;502m[Home]\
[200;442;503m[End][201m[37m´å¼Ð²¾°Ê  \
[200;442;506m[33m¡ö[q][37mµ²§ô[201m    [m\n");
//      prints(COLOR1" [1m[33m (^Z)[37m¨D§U \
//[33m¡÷¡õ [PgUp][PgDn][Home][End][37m´å¼Ð²¾°Ê [33m¡ö(q)[37mµ²§ô[m\n");
#endif
	move(b_lines,0);
