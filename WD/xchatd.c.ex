...
#define MAIN_TOPIC      "¬õ¼Ó³»¦y²á¤Ñ¼s³õ"
  ...
  int mode;
{
  ...
  board_chatman(currchatroom, count, NULL);
    ...
    sprintf(chatbuf, "¡° [1;32m%s[37m ¶i¤J [33m[%s][37m ¥]´[¡A¤H¼Æ¡G[36m[%d][m",
  ...
  int mode;
{
  ChatRoom *room;
  int create;
  char buf[64], title[BTLEN+1]="³o¬O¤@­Ó·s¤Ñ¦a\0";
...
int
chat_count_by_room(roomname)  //¬Y²á¤Ñ«Ç¤H¼Æ­pºâ
  char *roomname;
{
  int curr = 0;
  ChatUser *user;
...
int
board_chatman(char *brd, int man, char *title)  //¬ÝªO²á¤Ñ«Ç¤H¼Æ¦sÀÉ
{
    boardheader bh;
    int bid;
  ...
  ChatUser *cuser;
{
  ...
  sprintf(chatbuf,
    "¡ó Åwªï¥úÁ{¡A¥Ø«e½u¤W¦³ [1;31m%d[m ¶¡¥]´[¡C", roomc);
